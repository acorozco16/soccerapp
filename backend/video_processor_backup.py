    ...
    def __init__(self):
        ...
        try:
            ...
            if model_path.exists():
                ...
                self.yolo_confidence_threshold = 0.05  # Lower threshold to catch more detections
                ...
                print(f"⚠️ Custom trained model not found, falling back to traditional detection")
                logger.warning("Custom trained YOLO model not found, using traditional detection")
